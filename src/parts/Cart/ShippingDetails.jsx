						...
						<div className="flex -mx-2 flex-wrap">
							<div className="px-2 w-6/12 h-24 mb-4">
								<button
									...
									<img
										src="/assets/images/content/logo-fedex.svg"
										alt="Logo Fedex"
							...
							<div className="px-2 w-6/12 h-24 mb-4">
								<button
									...
									className="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
									<img
										src="/assets/images/content/logo-dhl.svg"
										alt="Logo dhl"
										className="object-contain max-h-full"
									/>
								</button>
						...
						<div className="flex -mx-2 flex-wrap">
							<div className="px-2 w-6/12 h-24 mb-4">
								<button
									...
									className="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
									<img
										src="/assets/images/content/logo-midtrans.png"
										alt="Logo midtrans"
										className="object-contain max-h-full"
									/>
								</button>
							...
							<div className="px-2 w-6/12 h-24 mb-4">
								<button
									...
									className="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
									<img
										src="/assets/images/content/logo-mastercard.svg"
										alt="Logo mastercard"
									/>
								</button>
							</div>
							<div className="px-2 w-6/12 h-24 mb-4">
								<button
									...
									className="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
									<img
										src="/assets/images/content/logo-bitcoin.svg"
										alt="Logo bitcoin"
										className="object-contain max-h-full"
									/>
								</button>
							...
							<div className="px-2 w-6/12 h-24 mb-4">
								<button
									...
									className="border border-gray-200 focus:border-red-200 flex items-center justify-center rounded-xl bg-white w-full h-full focus:outline-none">
									<img
										src="/assets/images/content/logo-american-express.svg"
